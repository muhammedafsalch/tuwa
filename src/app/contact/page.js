...
export const metadata = {
  title: "Contact Us | Tuwa Business Solutions",
  description: "Get in touch with Tuwa Business Solutions for expert corporate setup and PRO services in Qatar.",
  keywords: "Contact Tuwa Business Solutions, Corporate Services Doha Contact, Business Setup Consultation Qatar",
};
        ...
        <div className="max-w-3xl">
          <Reveal>
            ...
            <p className="text-lg text-gray-300">
              Whether you need to set up a new company, require PRO services, or have a question about legal translation, our team is ready to assist you.
            </p>
          </Reveal>
        </div>
      </section>
                ...
                <div className="flex flex-col gap-8">
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">Matar Qadeem Street<br/>Doha, State of Qatar</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">Sat - Thu: 8:00 AM - 6:00 PM<br/>Friday: Closed</p>
                    </div>
                  </div>
                </div>
              </GlassCard>
                ...
                <form className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    >
                      ...
                      <option className="bg-[#070B17]">Legal Translation</option>
                      <option className="bg-[#070B17]">Document Attestation</option>
                      <option className="bg-[#070B17]">Other Services</option>
                    </select>
                  </div>
