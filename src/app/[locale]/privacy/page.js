...
export async function generateMetadata({ params }) {
  ...
  const dict = dictObj['privacy']?.metadata;
  
  const title = dict?.title || "Privacy Policy | Tuwa Business Solutions";
  const description = dict?.description || "Privacy Policy for Tuwa Business Solutions.";
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://tuwabusiness.com/${locale}/privacy`
    }
  };
}
    ...
    <div className="flex flex-col pb-24 pt-32">
      <section className="container mx-auto px-6 relative z-10 mb-12">
        <div className="max-w-4xl mx-auto">
          <Reveal>
            <h1 className="text-4xl lg:text-5xl font-bold leading-tight mb-6">{dict?.title || "Privacy Policy"}</h1>
